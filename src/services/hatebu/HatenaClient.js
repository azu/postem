...
export default class HatenaClient {
    ...
    getContent(url) {
        ...
        return this._hatenaRequest()
            .get("https://api.b.hatena.ne.jp/1/my/bookmark?" + query)
            .then(response => {
    ...
    getTags() {
        return this._hatenaRequest()
            .get("https://api.b.hatena.ne.jp/1/my/tags")
            .then(response => {
    ...
    postLink(options = {}) {
        ...
        return this._hatenaRequest().post("https://api.b.hatena.ne.jp/1/my/bookmark?" + query);
    }
}
